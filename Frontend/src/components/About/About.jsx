  ...
  return (
    <Container fluid className="about-container">
      <div className="mb-3 p-3 text-center">
        <h4 className=" fs-1">We're Almost There!</h4>
      ...
      <Container fluid className="about-section my-5 p-2">
        <div className="about-content">
          <section className="about-item text-left">
            <h3>Exceptional Value, Uncompromised Quality</h3>
            <p>
              At Attention to Detail Auto, located in Pennsville NJ, we redefine
              what it means to get top-notch car detailing at an honest value.
              Our journey began with a clear vision: to offer the highest
              quality detailing at prices that don't break the bank. With our
              ceramic coatings starting at only $299.99, including paint
              correction, we stand out in a market where the average price
              starts at $1000.
            </p>
          </section>
          ...
          <section className="about-item">
            ...
            <p>
              ...
              Our rates are clear and available – you book, you pay, and you get
              the exceptional results you expect. No need for on-site
              quotations; we value your time as much as your trust in our
              services.
            </p>
          </section>
          ...
          <section className="about-item">
            ...
            <p>
              ...
              system in the local car detailing industry. With just a few
              clicks, you can schedule your car's transformation from the
              comfort of your home. This ease of access, combined with our
              commitment to quality, sets us apart and reflects our dedication
          ...
          <section className="about-item">
            ...
            <p>
              ...
              the conventional - it's an investment in your vehicle’s future.
            </p>
          </section>
          ...
          <section className="about-item">
            ...
            <p>
              ...
              Experience the unparalleled value and care that Attention to
              Detail Auto provides. It’s not just detailing; it’s a commitment
              to preserving and elevating your vehicle's beauty and value.
            </p>
          </section>
        </div>
      </Container>
